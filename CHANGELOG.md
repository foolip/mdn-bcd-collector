...
- (Fix test for XPathResult in old Firefox versions (#1507), 2021-09-21)
- (Sass it up! (#1502), 2021-09-21)
- (Add a type string for more event constructors (#1489), 2021-09-21)
- (Add documentation for how to review changes from the collector (#1436), 2021-09-21)
- (Add a privacy notice to homepage (#1499), 2021-09-20)
- (Fix import order in update-bcd script (#1501), 2021-09-18)
- (Add custom test for HTMLOptionsCollection (#1497), 2021-09-17)
- (Convert from CJS to ESM (#1475), 2021-09-16)
- (Attach GitHub token to auto-tag action (#1492), 2021-09-15)
-
- (Bump @webref/idl from 2.4.0 to 2.4.1 (#1498), 2021-09-16)
- (Bump @webref/css from 2.0.10 to 2.0.11 (#1494), 2021-09-16)
- (Bump @mdn/browser-compat-data from 4.0.3 to 4.0.4 (#1496), 2021-09-16)
